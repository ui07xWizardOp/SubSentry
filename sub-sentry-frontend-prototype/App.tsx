      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <Card className="lg:col-span-2">
          ...
          <p className="text-sm text-gray-500">
            &quot;The best subscription manager I&apos;ve ever used!&quot;
          </p>
        </Card>
            ...
            return (
              <div key={day} className="p-2 hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-colors relative group">
                ...
                <div className="mt-2 space-y-1.5">
                  {subs.map((sub, i) => (
                    <div key={i} className={`px-2 py-1 rounded-md text-xs font-semibold truncate border shadow-sm ${sub.category === 'Entertainment' ? 'bg-purple-50 text-purple-700 border-purple-100 dark:bg-purple-900/30 dark:text-purple-300 dark:border-purple-800' :
